...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        for w in range(self.width):
            for h in range(self.height):
                pos = (w, h)
                self.tile[pos] = self.dirt_amount

    def clean_tile_at_position(self, pos, capacity):
        """
        Mark the tile under the position pos as cleaned by capacity from amount of dirt.
        ...
        """
        # position = (pos.get_x(), pos.get_y())

        # if self.tile[position] - capacity >= 0:
        #     self.tile[position] -= capacity
        # else:
        #     self.tile[position] = 0

        tile_x = math.floor(pos.get_x())
        tile_y = math.floor(pos.get_y())

        if (tile_x, tile_y) not in self.tile:
            raise ValueError
        else:
            if self.tile[(tile_x, tile_y)] - capacity < 0:
    ...
    def get_num_tiles(self):  # not implemented
        """
    ...
    def is_position_valid(self, pos):  # not implemented
        """
        pos: a Position object.
    ...
    def get_random_position(self):  # not implemented
        """
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        """
        # Speed, Capacity and Room
        self.speed = speed
        self.capacity = capacity
        self.room = room
        # Direction and Position
        self.direction = math.floor(random.uniform(0.0, 360.0))
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        """
        # if (pos.get_x(), pos.get_y()) in self.furniture_tiles:
        #     return True
        # else:
        #     return False
    ...
    def get_num_tiles(self):
        ...
        """
        return int(self.width) * int(self.height) - len(self.furniture_tiles)
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        new_pos = pos.get_new_position(current_dir, current_speed)
        ...
        if self.room.is_position_valid(new_pos):
            ...
            self.set_robot_direction(math.floor(random.uniform(0.0, 360.0)))
...
show_plot_compare_strategies('Time to clean 80% of a 20x20 room, for various numbers of robots', 'Number of robots',
                             'Time / steps')
show_plot_room_shape('Time to clean 80% of a 300-tile room for various room shapes', 'Aspect Ratio',
                     'Time / steps')
